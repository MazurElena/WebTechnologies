<?php
$name = 'Елена'; // строка
$city = 'Подольск, Россия'; // строка
$profi = 'Бухгалтер'; // строка
$email = 'Lenchikpim@mail.ru'; // строка
$phone = 89161130069; // десятичное число
$age = 2023-1988;
$days = (2023-1988)*365;
...
<?php echo $workExperience['job_name'][0]; ?>
</b></h5>
<h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
<?php echo $workExperience['job_data'][0]; ?>
</h6>
<p>
<?php echo $workExperience['job_desc'][0]; ?>
</p>
<hr>
</div>
<div class="w3-container">
<h5 class="w3-opacity"><b>
<?php echo $workExperience['job_name'][1]; ?>
</b></h5>
<h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
<?php echo $workExperience['job_data'][1]; ?>
</h6>
<p>
<?php echo $workExperience['job_desc'][1]; ?>
</p>
<hr>
</div>
<div class="w3-container">
<h5 class="w3-opacity"><b>
<?php echo $workExperience['job_name'][2]; ?>
</b></h5>
<h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
<?php echo $workExperience['job_data'][2]; ?>
</h6>
<p>
<?php echo $workExperience['job_desc'][2]; ?>
</p><br>
</div>
</div>
